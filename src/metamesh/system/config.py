...
class Config(metaclass=Singleton):
    ...
    def _init_with_config_files_and_env(self, configs: dict, yaml_file):
        """Load from config/key.yaml / config/config.yaml / env in decreasing priority order"""
    ...
    def get(self, key, *args, **kwargs):
        """Search for the value in config/key.yaml / config/config.yaml / env, raise an error if not found"""

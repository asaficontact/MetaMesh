...
from metamesh.system.const import DATA_PATH
from metamesh.system.document_store.base_store import LocalStore
from metamesh.system.document_store.document import Document

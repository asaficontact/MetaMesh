...
def check_cmd_exists(command) -> int:
    ...
    :return: 0 if the command exists, non-0 if it does not
    """
...
class OutputParser:
    ...
    def parse_blocks(cls, text: str):
        ...
        for block in blocks:
            ...
            if block.strip() != "":
                # Split the block into title and content, and remove leading and trailing whitespace
                block_title, block_content = block.split("\n", 1)
                # LLM might make mistakes, so we fix it here
                if block_title[-1] == ":":
        ...
        for block, content in block_dict.items():
            ...
            if typing == List[str] or typing == List[Tuple[str, str]]:
                ...
                try:
                    ...
                    pass
            # TODO: Removing extra quotes is risky, will be solved later
            # elif typing == str:

...
from metamesh.actions.action_bank.search_and_summarize import SearchAndSummarize, SEARCH_AND_SUMMARIZE_SYSTEM_EN_US
...
class CreateRoles(Action):
    ...
    async def run(self, context, history='', suggestions=''):
        ...
        from metamesh.roles import ROLES_LIST
